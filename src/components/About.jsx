          ...
          <div className="lg:col-span-7 space-y-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-slate-400 text-lg leading-relaxed">
                <p>
                  I am a results-oriented Computer Science graduate from <span className="text-blue-400 font-semibold">Chandigarh University</span>, distinguished by a solid command of <span className="text-blue-400 font-medium">Java programming</span> and <span className="text-blue-400 font-medium">full-stack development</span>. My background is anchored in object-oriented principles, database optimization, and the deployment of modern web technologies.
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="group bg-slate-800/40 backdrop-blur-sm border border-slate-800 p-6 rounded-2xl hover:border-blue-500/30 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                ...
                <div className="space-y-2">
                  <p className="text-slate-200 font-medium">B.E. Computer Science</p>
                  <p className="text-slate-400 text-sm">Chandigarh University</p>
                  <div className="flex items-center gap-2 mt-2">
                    <span className="px-2 py-1 bg-emerald-500/10 text-emerald-400 text-xs font-semibold rounded border border-emerald-500/20">CGPA: 7.29</span>
              ...
              <div className="group bg-slate-800/40 backdrop-blur-sm border border-slate-800 p-6 rounded-2xl hover:border-blue-500/30 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                ...
                <div className="space-y-2">
                  <p className="text-slate-200 font-medium">Hyderabad, Telangana</p>
                  <p className="text-slate-400 text-sm">Available for Remote Work</p>
                  <div className="flex items-center gap-2 mt-2">
                    <span className="px-2 py-1 bg-blue-500/10 text-blue-400 text-xs font-semibold rounded border border-blue-500/20">Open to Relocate</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-slate-800/50 backdrop-blur-md border border-slate-800 p-8 rounded-[2.5rem] relative overflow-hidden shadow-2xl">
              ...
              <div className="text-center mb-10 relative z-10">
                <h4 className="text-2xl font-bold text-white mb-2">My Journey</h4>
                <p className="text-slate-400 text-sm">Key milestones in my development career</p>
              </div>
              
              <div className="grid grid-cols-2 gap-6 relative z-10">
                {[
                  { icon: Code, value: '4+', label: 'Years Learning', color: 'text-blue-400' },
                  { icon: Trophy, value: '3+', label: 'Projects Built', color: 'text-purple-400' },
              ...
              <div className="mt-10 pt-8 border-t border-slate-800 text-center relative z-10">
                <p className="text-slate-400 text-sm mb-4">Ready to collaborate?</p>
                <button 
