      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20 animate-fade-in-up">
          <div className="inline-flex items-center gap-2 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-200 dark:border-slate-800 mb-6">
            ...
            <span className="text-slate-600 dark:text-slate-300 font-medium text-sm">Academic Journey</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold text-slate-900 dark:text-white mb-6 tracking-tight">
            Education <span className="text-blue-600 dark:text-blue-500">Timeline</span>
          </h1>
                ...
                <SpotlightCard className="p-8 hover:shadow-lg hover:shadow-blue-500/5 hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-shrink-0">
                      <div className="w-14 h-14 rounded-xl bg-slate-200 dark:bg-slate-800 flex items-center justify-center group-hover:bg-blue-600/20 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-all duration-300 text-slate-500 dark:text-white">
                        {getIcon(edu.icon)}
                      </div>
                    </div>
